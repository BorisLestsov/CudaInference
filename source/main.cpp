...
int main(int argc, const char** argv)
{
    ...
    try {
        ...
        std::string w_path = "../python/weights/";

        // stub

        ConvLayer* conv1 = new ConvLayer(cublas_handle, w_path+"conv1", n, 3, 2, false);
        BatchNormLayer* bn1 = new BatchNormLayer(w_path+"bn1", n);
        ReluLayer* relu1 = new ReluLayer(n);
        MaxPoolLayer* mp1 = new MaxPoolLayer(n, 3, 2, 1);
        ...
        // layer1
            ...
            // block1
        ConvLayer* layer1_0_conv1 = new ConvLayer(cublas_handle, w_path+"layer1.0.conv1", n, 1, 1, false);
        BatchNormLayer* layer1_0_bn1 = new BatchNormLayer(w_path+"layer1.0.bn1", n);
        ReluLayer* layer1_0_relu1 = new ReluLayer(n);
        ConvLayer* layer1_0_conv2 = new ConvLayer(cublas_handle, w_path+"layer1.0.conv2", n, 1, 1, false);
        BatchNormLayer* layer1_0_bn2 = new BatchNormLayer(w_path+"layer1.0.bn2", n);
        ReluLayer* layer1_0_relu2 = new ReluLayer(n);
        ...
        layer1_0_relu2->set_input(layer1_0_bn2->get_output());
            ...
            // block2
        ConvLayer* layer1_1_conv1 = new ConvLayer(cublas_handle, w_path+"layer1.1.conv1", n, 1, 1, false);
        BatchNormLayer* layer1_1_bn1 = new BatchNormLayer(w_path+"layer1.1.bn1", n);
        ReluLayer* layer1_1_relu1 = new ReluLayer(n);
        ConvLayer* layer1_1_conv2 = new ConvLayer(cublas_handle, w_path+"layer1.1.conv2", n, 1, 1, false);
        BatchNormLayer* layer1_1_bn2 = new BatchNormLayer(w_path+"layer1.1.bn2", n);
        ReluLayer* layer1_1_relu2 = new ReluLayer(n);
        ...
        // layer2
            ...
            // block1
        ConvLayer* layer2_0_conv1 = new ConvLayer(cublas_handle, w_path+"layer2.0.conv1", n, 1, 2, false);
        BatchNormLayer* layer2_0_bn1 = new BatchNormLayer(w_path+"layer2.0.bn1", n);
        ReluLayer* layer2_0_relu1 = new ReluLayer(n);
        ConvLayer* layer2_0_conv2 = new ConvLayer(cublas_handle, w_path+"layer2.0.conv2", n, 1, 1, false);
        BatchNormLayer* layer2_0_bn2 = new BatchNormLayer(w_path+"layer2.0.bn2", n);
        ReluLayer* layer2_0_relu2 = new ReluLayer(n);

            // downsample
        ConvLayer* layer2_0_downsample_0_conv = new ConvLayer(cublas_handle, w_path+"layer2.0.downsample.0", n, 0, 2, false);
        BatchNormLayer* layer2_0_downsample_1_bn = new BatchNormLayer(w_path+"layer2.0.downsample.1", n);
        ...
        layer2_0_downsample_1_bn->set_input(layer2_0_downsample_0_conv->get_output());
            ...
            // block2
        ConvLayer* layer2_1_conv1 = new ConvLayer(cublas_handle, w_path+"layer2.1.conv1", n, 1, 1, false);
        BatchNormLayer* layer2_1_bn1 = new BatchNormLayer(w_path+"layer2.1.bn1", n);
        ReluLayer* layer2_1_relu1 = new ReluLayer(n);
        ConvLayer* layer2_1_conv2 = new ConvLayer(cublas_handle, w_path+"layer2.1.conv2", n, 1, 1, false);
        BatchNormLayer* layer2_1_bn2 = new BatchNormLayer(w_path+"layer2.1.bn2", n);
        ReluLayer* layer2_1_relu2 = new ReluLayer(n);
        ...
        // layer3
            ...
            // block1
        ConvLayer* layer3_0_conv1 = new ConvLayer(cublas_handle, w_path+"layer3.0.conv1", n, 1, 2, false);
        BatchNormLayer* layer3_0_bn1 = new BatchNormLayer(w_path+"layer3.0.bn1", n);
        ReluLayer* layer3_0_relu1 = new ReluLayer(n);
        ConvLayer* layer3_0_conv2 = new ConvLayer(cublas_handle, w_path+"layer3.0.conv2", n, 1, 1, false);
        BatchNormLayer* layer3_0_bn2 = new BatchNormLayer(w_path+"layer3.0.bn2", n);
        ReluLayer* layer3_0_relu2 = new ReluLayer(n);

            // downsample
        ConvLayer* layer3_0_downsample_0_conv = new ConvLayer(cublas_handle, w_path+"layer3.0.downsample.0", n, 0, 2, false);
        BatchNormLayer* layer3_0_downsample_1_bn = new BatchNormLayer(w_path+"layer3.0.downsample.1", n);
        ...
        layer3_0_downsample_1_bn->set_input(layer3_0_downsample_0_conv->get_output());
            ...
            // block2
        ConvLayer* layer3_1_conv1 = new ConvLayer(cublas_handle, w_path+"layer3.1.conv1", n, 1, 1, false);
        BatchNormLayer* layer3_1_bn1 = new BatchNormLayer(w_path+"layer3.1.bn1", n);
        ReluLayer* layer3_1_relu1 = new ReluLayer(n);
        ConvLayer* layer3_1_conv2 = new ConvLayer(cublas_handle, w_path+"layer3.1.conv2", n, 1, 1, false);
        BatchNormLayer* layer3_1_bn2 = new BatchNormLayer(w_path+"layer3.1.bn2", n);
        ReluLayer* layer3_1_relu2 = new ReluLayer(n);
        ...
        // layer3
            ...
            // block1
        ConvLayer* layer4_0_conv1 = new ConvLayer(cublas_handle, w_path+"layer4.0.conv1", n, 1, 2, false);
        BatchNormLayer* layer4_0_bn1 = new BatchNormLayer(w_path+"layer4.0.bn1", n);
        ReluLayer* layer4_0_relu1 = new ReluLayer(n);
        ConvLayer* layer4_0_conv2 = new ConvLayer(cublas_handle, w_path+"layer4.0.conv2", n, 1, 1, false);
        BatchNormLayer* layer4_0_bn2 = new BatchNormLayer(w_path+"layer4.0.bn2", n);
        ReluLayer* layer4_0_relu2 = new ReluLayer(n);

            // downsample
        ConvLayer* layer4_0_downsample_0_conv = new ConvLayer(cublas_handle, w_path+"layer4.0.downsample.0", n, 0, 2, false);
        BatchNormLayer* layer4_0_downsample_1_bn = new BatchNormLayer(w_path+"layer4.0.downsample.1", n);
        ...
        layer4_0_downsample_1_bn->set_input(layer4_0_downsample_0_conv->get_output());
            ...
            // block2
        ConvLayer* layer4_1_conv1 = new ConvLayer(cublas_handle, w_path+"layer4.1.conv1", n, 1, 1, false);
        BatchNormLayer* layer4_1_bn1 = new BatchNormLayer(w_path+"layer4.1.bn1", n);
        ReluLayer* layer4_1_relu1 = new ReluLayer(n);
        ConvLayer* layer4_1_conv2 = new ConvLayer(cublas_handle, w_path+"layer4.1.conv2", n, 1, 1, false);
        BatchNormLayer* layer4_1_bn2 = new BatchNormLayer(w_path+"layer4.1.bn2", n);
        ReluLayer* layer4_1_relu2 = new ReluLayer(n);
        ...
        // head
        AvgPoolLayer* avg_pool = new AvgPoolLayer(2, 7);
        LinearLayer* linear = new LinearLayer(cublas_handle, w_path+"fc", n);

        avg_pool->set_input(layer4_1_relu2->get_output());
        linear->set_input(avg_pool->get_output());


        Tensor<float>* output = linear->get_output();
        ...
        Tensor<float>::add_inplace(layer1_0_bn2->get_output(), mp1->get_output());
        ...
        Tensor<float>::add_inplace(layer1_1_bn2->get_output(), layer1_0_relu2->get_output());
        ...
        Tensor<float>::add_inplace(layer2_0_bn2->get_output(), layer2_0_downsample_1_bn->get_output());
        ...
        Tensor<float>::add_inplace(layer2_1_bn2->get_output(), layer2_0_relu2->get_output());
        ...
        Tensor<float>::add_inplace(layer3_0_bn2->get_output(), layer3_0_downsample_1_bn->get_output());
        ...
        Tensor<float>::add_inplace(layer3_1_bn2->get_output(), layer3_0_relu2->get_output());
        ...
        Tensor<float>::add_inplace(layer4_0_bn2->get_output(), layer4_0_downsample_1_bn->get_output());
        ...
        Tensor<float>::add_inplace(layer4_1_bn2->get_output(), layer4_0_relu2->get_output());
