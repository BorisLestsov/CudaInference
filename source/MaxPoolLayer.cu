...
MaxPoolLayer::MaxPoolLayer(int batch_size_p, int ker_size_p, int stride_p, int pad_p):
...
void MaxPoolLayer::set_input(Tensor<float>* input)
{
...
Tensor<float>* MaxPoolLayer::get_output()
{
    return _res;
}
